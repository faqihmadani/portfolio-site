        ...
        <div className="rounded-xl bg-slate-50 dark:bg-slate-700 flex flex-col shadow-lg hover:shadow-xl min-h-[500px] border border-gray-300 dark:border-gray-500 hover:scale-105 transition-transform  dark:hover:shadow-gray-300/10  ">
            ...
            <div className="p-6 flex flex-col justify-between">
                ...
                <div className="flex space-x-4 items-center mt-8">
                    {data.demo && <a href={data.demo} target="_blank" rel="noreferrer" className="flex items-center justify-center px-6 py-2 font-inter text-sm text-blue-100 transition-colors duration-300 bg-blue-500 rounded-full shadow-md hover:bg-blue-600 dark:shadow-blue-400/20 shadow-blue-800/30">

...
const Navbar = ({ handleDarkMode }) => {
    ...
    return (
        <header className='fixed w-full z-50'>
            <div className="w-full dark:bg-slate-900 bg-slate-100 py-4 font-inter transition-colors duration-300 ">
            ...
            <AnimatePresence>
                {border || isOpen ?
                    <motion.div initial={{ width: 0 }} animate={{ width: "100%" }} exit={{ opacity: 0 }} transition={{ type: "tween" }} className='w-full h-[3px] bg-gradient-to-r from-blue-500 to-blue-400 dark:from-blue-700 dark:to-blue-500 absolute'></motion.div> : ""
                }
            </AnimatePresence>
            {isOpen && <motion.nav className="flex  items-start flex-col justify-center bg-slate-100 dark:bg-slate-900 space-y-3 py-2 border-b-[2px] border-slate-300 dark:border-gray-800">
                ...
                {/* <a className="py-1 px-4 rounded-lg dark:text-slate-400 dark:hover:text-slate-100 text-slate-600 hover:text-slate-900  dark:border-slate-900 hover:bg-blue-200 dark:hover:bg-slate-700 transition-all duration-300" href="#home">Home</a> */}
                <a className="py-2 font-medium px-4 rounded-lg dark:text-slate-400 dark:hover:text-slate-100 text-slate-500 hover:text-slate-900  dark:border-slate-900 hover:bg-blue-200 dark:hover:bg-slate-700 transition-all duration-300" href="#projects">Projects</a>
                <a className="py-2 font-medium px-4 rounded-lg dark:text-slate-400 dark:hover:text-slate-100 text-slate-500 hover:text-slate-900  dark:border-slate-900 hover:bg-blue-200 dark:hover:bg-slate-700 transition-all duration-300" href="#about">About</a>
                <a className="py-2 font-medium px-4 rounded-lg dark:text-slate-400 dark:hover:text-slate-100 text-slate-500 hover:text-slate-900  dark:border-slate-900 hover:bg-blue-200 dark:hover:bg-slate-700 transition-all duration-300" href="#contact">Contact</a>
            </motion.nav>}

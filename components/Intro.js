            ...
            <div className=" flex flex-col-reverse sm:flex-row justify-between items-center h-full w-full">
                <div>
                    ...
                    <div className="flex flex-col text-3xl md:text-4xl font-extrabold space-y-2 mb-7">
                        <h1>a <span className=" text-transparent bg-gradient-to-tr dark:from-blue-400 from-blue-700 to-blue-400 dark:to-blue-300 bg-clip-text">web developer</span></h1>
                ...
                <div className="flex w-6/12 justify-center pt-20 sm:pt-0 mb-10 sm:mb-0">
                    <div className="relative flex items-center justify-center">
                        <div className="relative  z-30 w-[140px] h-[140px]  sm:w-[200px] sm:h-[200px] md:w-[250px] md:h-[250px]">
                            ...
                            <Image src="/profil-blue.png" alt="hero-image" layout="fill"

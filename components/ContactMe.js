        ...
        <section id="contact" className="flex items-center max-w-screen-lg justify-between w-11/12 md:w-10/12 lg:w-9/12 xl:w-8/12 min-h-screen xl:min-h-[564px] mx-auto font-inter text-slate-900 dark:text-slate-100 transition-colors duration-300">
            <div className="w-full">
                ...
                <div className="mt-5 flex justify-between space-x-10">
                    ...
                    <div className="w-2/3">
                        <form name="contact" method="POST" data-netlify="true" class="mb-6 space-y-5">
                            {/* <label for="name" class="block mb-2 text-lg font-medium text-gray-900 dark:text-gray-300">Full Name : </label> */}
                            <input name="name" type="text" placeholder="Your full name" id="name" class="text-lg bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />

                            {/*     <label for="email" class="block mb-2 text-lg font-medium text-gray-900 dark:text-gray-300">Email : </label> */}
                            <input name="email" type="email" placeholder="Your email" id="email" class="text-lg bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
